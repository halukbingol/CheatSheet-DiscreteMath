...
\begin{tabular}{@{}ll@{}}
%	=
	$x  \doteq  y$	&\verb!x  \doteq  y!\\
	$x  \equiv  y$	&\verb!x  \equiv  y!\\
	$x \propto y$	&\verb!x \propto y!\\
	$x \approx y$	&\verb!x \approx y!\\
	$x = y \ne z$	&\verb!x = y \ne z!\\
%	<
	$x \ll y$ &\verb!x \ll y!\\
	$x < y \nless z$	&\verb!x < y \nless z!\\s
	$x \leq y \nleq z$	&\verb!x leq y \nleq z!\\
	$x  \prec  y \nprec z$	&\verb!x  \prec  y \nprec z!\\
	$x  \preceq  y  \npreceq  z$	&\verb!x  \preceq  y  \npreceq  z!\\
%	>
	$x \gg y$ &\verb!x \gg y!\\
	$x > y \ngtr z$	&\verb!x > y \ngtr z!\\
	$x \geq y \ngeq z$	&\verb!x \geq y \ngeq z!\\
	$x  \succ  y  \nsucc  z$	&\verb!x  \succ  y  \nsucc  z!\\
	$x  \succeq  y  \nsucceq  z$	&\verb!x  \succeq  y  \nsucceq  z!\\

%	$x aaa y bbb z$	&\verb!x aaa y bbb z!\\
%	$x aaa y bbb z$	&\verb!x aaa y bbb z!\\
%
%	$aaa$	&\verb!aaa!\\
%	$aaa$	&\verb!aaa!\\
