...
\begin{center}
	...
	\small{
		\href
			{https://github.com/halukbingol/zintLaTeXCheatSheet-DiscreteMath}
			{https://github.com/halukbingol/zintLaTeXCheatSheet-DiscreteMath}
	}\\
	\small{\hbTimeStamp}
\end{center}
...
\begin{tabular}{@{}ll@{}}
	...
	$a \overset{\triangle}{\longleftrightarrow} b$	&\verb!a \overset{\triangle}{\longleftrightarrow} b!\\
...
%	$\hBinaryEntropy$ &\verb!\hBinaryEntropy!\\
	$\sum_{i=1}^{n} a_{i}$ &\verb!\sum_{i=1}^{n} a_{i}!\\
	$\prod_{i=1}^{n} a_{i}$ &\verb!\prod_{i=1}^{n} a_{i}!\\
...
\begin{tabular}{@{}ll@{}}
	...
	${n \choose r}$ = $n$ choose $r$	&\verb!{n \choose r}!\\[4pt]
	${n \brack r}$ = Stirling cycle number	&\verb!{n \brack r}!\\[4pt]
	${n \brace r}$ = Stirling subset number &\verb!{n \brace r}!\\[3pt]
